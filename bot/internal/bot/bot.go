...
import (
	...
	"github.com/khulnasoft-lab/shared-workflows/bot/internal/env"
	"github.com/khulnasoft-lab/shared-workflows/bot/internal/github"
	"github.com/khulnasoft-lab/shared-workflows/bot/internal/review"
...
func (b *Bot) isInternal(ctx context.Context) (bool, error) {
	...
	return b.c.GitHub.IsOrgMember(ctx, b.c.Environment.Author, "khulnasoft-lab")
}
